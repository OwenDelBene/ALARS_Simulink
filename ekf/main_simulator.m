...
function states = main_simulator(Rmag, Qmag)
...
Q = diag([[1 1 1 1] * 0.00005, [1 1 1] * 0.000001] .^ 2) * Qmag * 1e-2;
%measurement noise matrix
R = diag([[1 1 1] * 0.045, [1 1 1] * 0.015]) * Rmag * 1e-2;
...
states.true = [phi_komp; theta_komp;];
